...
may be still achieved by using the \texttt{-u false} option.\footnote{Any
  Emacs lisp file \url{proofgeneral-settings.el} occurring in
  \url{$ISABELLE_HOME/etc} or \url{$ISABELLE_HOME_USER/etc} is automatically
  loaded by the Proof~General interface script as well.}
