...
object Isabelle
{
  ...
  def skip_proofs_=(b: Boolean): Unit =
  {
    GUI_Thread.require(())
  ...
  def set_skip_proofs():Unit = { skip_proofs = true }
  def reset_skip_proofs():Unit = { skip_proofs = false }
  def toggle_skip_proofs():Unit = { skip_proofs = !skip_proofs }
  ...
  class Skip_Proofs extends CheckBox("Skip proofs")
  {
    ...
    def load():Unit = { selected = skip_proofs }
    load()
  }
...
/* defer proofs */
  ...
  def defer_proofs_=(b: Boolean):Unit =
  {
    GUI_Thread.require(())
  ...
  def set_defer_proofs():Unit = { defer_proofs = true }
  def reset_defer_proofs():Unit = { defer_proofs = false }
  def toggle_defer_proofs():Unit = { defer_proofs = !defer_proofs }
  ...
  class Defer_Proofs extends CheckBox("Defer proofs")
  {
    ...
    def load():Unit = { selected = defer_proofs }
    load()
  }
